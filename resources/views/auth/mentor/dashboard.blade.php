                                ...
                                <div class="card card-dashboard-one">
                                    <div class="card-header">
                                        <div>
                                            ...
                                            <p class="card-text">Metrics of students who have registered within the current
                                                date range.</p>
                                        </div>
                                        <div class="btn-group">
                                    ...
                                    <tbody>
                                        @foreach ($students as $key => $student)
                                            <tr>
                                                ...
                                                <td>{{ $student->email }}</td>
                                                <td><span
                                                        class="badge rounded-pill bg-primary text-white">{{ getNumberOfCourse($student->course_id) }}</span>
                                                </td>
                                                <td><span
                                                        class="badge rounded-pill bg-success text-white">{{ getNumberOfCourse($student->membership_id) }}</span>
                                                </td>
                                                <td>
                    ...
                    <div class="tab-pane" id="student-registration">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="{{ route('mentor.store-student-registration') }}" method="POST"
                                        ...
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="emergency_contact_number"
                                                    id="emergency_contact_number" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="emergency_contact_email"
                                                    id="emergency_contact_email" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-4 col-sm-6">
                                            <div class="form-group">
                    ...
                    <div class="col-lg-6 mg-t-20 mg-lg-t-0">
                        <div class="row row-sm">
                            ...
                            <div class="col-sm-6 mg-t-20 mg-sm-t-0">
                                <div class="card card-dashboard-two">
                                    <div class="card-header">
                                        <h6>{{ number_format($noOfStudent, 2) }} <i
                                ...
                                <div class="card card-dashboard-three">
                                    <div class="card-header">
                                        ...
                                        <h6>16,869 <small class="tx-success"><i class="icon ion-md-arrow-up"></i>
                                                2.87%</small></h6>
                                        <small>Total number of active sessions for the registered students during the
                    ...
                    <div class="col-lg-6">
                        <div class="card card-dashboard-pageviews">
                            <div class="card-header">
                                ...
                                <p class="card-text">This report shows the number of registrations per course within the
                                    selected period.</p>
                            </div><!-- card-header -->
                            <div class="card-body">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-6 col-lg-5 mg-lg-l-auto mg-t-20 mg-md-t-0">
                                    @php
                                        ...
                                        // Check if the total number of students is greater than 0
                                        if ($noOfStudent > 0) {
                                            ...
                                            // If no students, you can handle the case gracefully
                                            // e.g., set percentages to 0, or an empty array
                                            $months = [];
                                            $registrationCounts = [];
                                            $percentages = [];
                                        }
                                    ...
                                    @foreach ($monthlyRegistrations as $month => $registrationCount)
                                        @php
                                            // Check if $noOfStudent is greater than 0 to avoid division by zero
                                            if ($noOfStudent > 0) {
                                                $percentage = ($registrationCount / $noOfStudent) * 100;
                                            } else {
                                                $percentage = 0; // Assign 0 if no students
                                            }
                                        @endphp
                                        ...
                                        <div class="az-traffic-detail-item">
                                            <div>
                                                ...
                                                <span>{{ $registrationCount }}
                                                    <span>({{ number_format($percentage, 0) }}%)</span></span>
                                            </div>
                                            <div class="progress">
                                                <div class="progress-bar bg-{{ ['purple', 'primary', 'info', 'teal'][$month % 4] }} wd-{{ number_format($percentage, 0) }}p"
                                                    role="progressbar"
                                                    aria-valuenow="{{ number_format($percentage, 0) }}" aria-valuemin="0"
                            ...
                            <div class="col-md-6 col-lg-12 mg-b-20 mg-md-b-0 mg-lg-b-20">
                                <div class="card card-dashboard-five">
                                    <div class="card-header">
                                        ...
                                        <span class="card-text">Tells you where your students originated from, such as
                                            search engines, social media, or referrals.</span>
                                    </div><!-- card-header -->
    ...
    <script>
        $(function() {
            ...
            const registrationCounts =
                @json($registrationCounts); // Array of corresponding registration counts (e.g. [25, 20, 30, 15, 10])
            ...
            var datapie = {
                ...
                datasets: [{
                    ...
                    backgroundColor: ['#6f42c1', '#007bff', '#17a2b8', '#00cccc', '#adb2bd', '#ff5733',
                        '#33c9ff', '#f7e400', '#0a8102', '#c70039', '#f09144', '#922d7d'
                    ], // Example color set for each month
                }]
            };
