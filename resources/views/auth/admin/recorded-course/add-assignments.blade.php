            ...
            <div class="assigment-title-decription-new-section">
                <div class="assigment-title-decription">
                    <div class="assigment-title">
                        <input type="text" id="assignment-title-1" name="assignment-title" placeholder="Assignment title"
                            required>
                    </div>
                    <div class="assigment-title">
                        <input type="text" id="assignment-title-2" name="assignment-description"
                ...
                <div class="assigment-title-decription new-section" id="hidden-section">
                    <div class="assigment-title d-flex align-items-center">
                        <input class="newSectionInput" type="text" name="new-assignment-title" placeholder="Question"
                            required>
