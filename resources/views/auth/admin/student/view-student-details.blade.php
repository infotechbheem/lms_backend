            ...
            <div class="row">
                <div class=" col-lg-3 col-md-4 col-sm-12">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                <img class="profile-user-img img-fluid img-circle" src="{{ asset('storage/'. $student->profile_picture) }}" alt="User profile picture">
                            </div>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Registration Date</b> <a class="float-right">{{ \Carbon\Carbon::parse($student->created_at)->format('d-m-Y') }}</a>
                                </li>
                            </ul>
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <strong><i class="fas fa-book mr-1"></i> Update Details</strong> : <a href="{{ route('admin.update-student-details', $student->student_id) }}">Click Here</a>
                            <hr>
                            <strong><i class="fas fa-map-marker-alt mr-1"></i> Student Role</strong>

                            <p class=" m-0 pl-3 text-muted">Student : Yes</p>
                            <p class=" m-0 pl-3 text-muted">Mentor : Yes</p>
                            <p class=" m-0 pl-3 text-muted">Volunteer : Yes</p>

                            <hr>
                            <strong><i class="fas fa-pencil-alt mr-1"></i> Total Student Registration</strong> : <span>30</span>
                            <hr>

                            <strong><i class="far fa-file-alt mr-1"></i> Upload Profile Image : </strong><span class="text-muted"> <a href="">Click Here</a> </span>
                        </div>
                        <!-- /.card-body -->
                    </div>
                    <!-- /.card -->
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Academic Criteria</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <strong><i class="fas fa-book mr-1"></i>Total Present</strong> : <span></span>
                            <hr>
                            <strong><i class="fas fa-map-marker-alt mr-1"></i> Course</strong>
                            <hr>
                            <strong><i class="fas fa-pencil-alt mr-1"></i> Total Student Registration</strong> : <span>30</span>
                            <hr>
